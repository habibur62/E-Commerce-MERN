...
export default function EditProduct({closeEdti, editProduct, callProduct}) {
    ...
    const handleEditProduct = async (e) =>{
        e.preventDefault()
        try {
            const dataResponse= await fetch(SummaryApi.updateProducts.url, {
  ...
  return (
    <div>
        ...
        <div className='bg-white p-5 rounded w-full max-w-2xl h-full max-h-[70%] overflow-scroll'>
            ...
            <form className='grid' onSubmit={handleEditProduct}>
